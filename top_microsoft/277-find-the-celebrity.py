...
is to ask questions like: "Hi, A. Do you know B?" to get information about whether A knows B. You need to find out the 
    ...
    def findCelebrity(self, n: int) -> int:  
        ...
        for person in range(0, n):
            if person != possibleCelebrity:
                if knows(possibleCelebrity, person) or not knows(person,possibleCelebrity):
                    return -1
